...
class ItemsController {
    ...
    val categories: Set<Category>
        get() {
            ...
            cats.add(Category.create("amis","a","mi"))

            cats.add(Category.create("Famille","fa","mil","le"))
            cats.add(Category.create("Professionnels","pro","fe","ssio","nnels"))
            return cats
        }
    @RequestMapping("/")
